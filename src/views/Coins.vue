  ...
  <v-container>
    <v-row class="text-center">
      <v-col class="mb-4">
        ...
        <p class="subheading font-weight-regular">Moedas para serem gastas na loja de itens do BOT</p>
      </v-col>
      <v-col v-if="isLogged" class="mb-5" cols="12">
        <h2 class="headline font-weight-bold mb-3">Como adquirir?</h2>
        <v-row justify="center" class="mb-6">Basta responder o captcha abaixo.</v-row>
        <v-row justify="center" class="mb-6">
          <vue-hcaptcha :sitekey="hcaptchaKey" @verify="getCoins"></vue-hcaptcha>
        </v-row>
        <v-row justify="center" class="mb-6">
          <v-progress-circular indeterminate color="primary" v-show="verifying"></v-progress-circular>
        </v-row>
      ...
      <v-col v-else class="mb-5" cols="12">Você precisa estar logado para pegar moedas.</v-col>
    </v-row>
  </v-container>
</template>
